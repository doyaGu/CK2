...
public:
    ...
    ************************************************/
    XBaseString() : m_Buffer(NULL), m_Length(0), m_Allocated(0) {}
...
public:
    ...
    XString(const char *iString, const int iLength = 0) : XBaseString()
    {
        if (!iString || *iString == '\0')
        {
            ...
            m_Buffer = (char *)VxMalloc(sizeof(char) * m_Allocated);
    ...
    explicit XString(const int iLength) : XBaseString()
    {
        ...
        m_Buffer = (char *)VxMalloc(sizeof(char) * (iLength + 1));
    ...
    *************************************************/
    ...
    int Replace(const XBaseString &iSrc, const XBaseString &iDest)
    {
        ...
        else
        {
            ...
            char *buf = (char *)VxMalloc(sizeof(char) * (len + 1));
    ...
    ************************************************/
    ...
    void Reserve(XWORD iLength)
    {
        ...
        {
            m_Allocated = iLength + 1;
            char *buf = (char *)VxMalloc(sizeof(char) * (iLength + 1));
            if (m_Length != 0)
